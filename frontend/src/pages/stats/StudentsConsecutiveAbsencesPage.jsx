...
export default function StudentsConsecutiveAbsencesPage() {
    ...
    useEffect(() => {
        setLoading(true)
        statsService.studentsConsecutiveAbsences(page, academicYearId)
            .then((res) => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold">Absences sur 4 séances consécutives</h1>
                        ...
                        {loading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={4} className="py-16 text-center text-sm text-muted-foreground">
                                    Aucun étudiant n'a 4 absences consécutives.
                                </TableCell>
                            </TableRow>
                        ) : (
                                ...
                                <TableRow key={student.id}>
                                    ...
                                    <TableCell className="text-right">
                                        <span className="rounded-full bg-amber-500/10 px-2.5 py-1 text-xs font-semibold text-amber-600">
                                            {student.consecutive_absences} séances
                                        </span>
                                    </TableCell>
                                </TableRow>
                            ))
